...
import com.bai.kafka.KafkaConsumerService;
import com.bai.kafka.KafkaProducerService;
import com.bai.kafka.KafkaTopicConfig;
import com.bai.kafka.StatusTransacaoPayload;
import com.bai.kafka.StatusTransferenciaInterbancariaPayload;
import com.bai.kafka.StatusTransferenciaPayload;
import com.bai.kafka.TransacaoPayload;
import com.bai.kafka.TransferenciaInterbancariaPayload;
import com.bai.kafka.TransferenciaPayload;
import com.bai.model.Conta;
import com.bai.model.Status;
import com.bai.model.TipoConta;
import com.bai.repository.ContaRepository;
...
public class ContaServiceImpl extends AbstractServiceImpl<Conta, UUID, ContaRepository> implements ContaService, KafkaConsumerService {
	...
	public ContaServiceImpl(ContaRepository repository, HttpServletRequest request, 
			MessageSource messageSource, @Value("${application.bai.prefix-iban}") String prefixIBAN, 
			@Value("${application.bai.size-account-number}") Integer sizeAccountNumber, 
	...
	@Override
	@KafkaListener(topics = KafkaTopicConfig.TOPIC_BAI_TRANSACTION, groupId = "group-bank")
	public void createTransaction(String payload) {
		log.info("========>  BAI receiveTransaction: " + payload);
	...
	@Override
	@KafkaListener(topics = KafkaTopicConfig.TOPIC_BAI_TRANSFER, groupId = "group-bank")
	public void createTransfer(String payload) {
		log.info("========>  BAI receiveTransfer JSON: " + payload);
	...
	@Override
	@KafkaListener(topics = KafkaTopicConfig.TOPIC_BAI_INTERBANK_TRANSFER, groupId = "group-bank")
	public void receiveIntebankTransfer(String payload) {
		log.info("========>  BAI receiveIntebankTransfer: " + payload);
	...
	@Override
	@KafkaListener(topics = KafkaTopicConfig.TOPIC_BAI_STATUS_INTERBANK_TRANSFER, groupId = "group-bank")
